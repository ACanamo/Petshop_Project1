...
export const DEFAULT_PRODUCTS = [
  ...
  },
  {
    id: "p13-cat-tree",
    sku: "PET-ACC-005",
    name: "Cozy Cloud Multi-Tier Cat Scratching Tree",
    category: "accessories",
    categoryLabel: "Accessories",
    pet: "cat",
    price: 58.00,
    ...
    badgeClass: "badge-bestseller",
    tintClass: "bg-teal-tint",
    desc: "Natural sisal rope pillars with ultra-plush observation perches and hammock.",
    stockQuantity: 8,
    inStock: true
  },
  {
    id: "p14-cat-grass",
    sku: "PET-WEL-003",
    name: "Organic Sweet Wheatgrass Grow Kit",
    category: "wellness",
    categoryLabel: "Wellness",
    pet: "cat",
    price: 11.99,
    ...
    badgeClass: "badge-health",
    tintClass: "bg-yellow-tint",
    desc: "Sprouts in just 5 days! Helps hairball control and digestive health naturally.",
    stockQuantity: 40,
    inStock: true
  },
  {
    id: "p15-dental",
    sku: "PET-WEL-004",
    name: "Fresh Breath Dental Care Water Additive",
    category: "wellness",
    categoryLabel: "Wellness",
    pet: "all",
    price: 13.99,
    ...
    badgeClass: "badge-health",
    tintClass: "bg-teal-tint",
    desc: "Tasteless water additive eliminates plaque and freshens breath for both cats and dogs.",
    stockQuantity: 35,
    inStock: true
  },
  {
    id: "prod-1789557436707",
    sku: "SKU-436707",
    name: "Sunset food",
    category: "feeds",
    categoryLabel: "Pet Goodies",
    pet: "dog",
    price: 12.00,
    originalPrice: 12.00,
    rating: 5,
